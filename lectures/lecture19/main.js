...
function displayResults(data) {
    console.log(data); //display all data to console

    console.log(data[0].Title);  //display first item's title to console
    document.querySelector("#results").innerHTML = data[0].Title; //display first item's title to HTML 
